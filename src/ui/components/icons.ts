...
export const icons = {
  ...
  kana: `<svg ${common}><path d="M6 5h12M9 3c0 7-1 13-5 17M8 11c3 0 7 1 10 6M15 7c0 6 1 10 5 13"/></svg>`,
  ...
  volume: `<svg ${common}><path d="M11 5 6 9H3v6h3l5 4V5Z"/><path d="M15 9a4 4 0 0 1 0 6M18 6a8 8 0 0 1 0 12"/></svg>`,
};
